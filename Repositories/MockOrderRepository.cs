...
public class MockOrderRepository : IOrderRepository
{
    private static readonly IReadOnlyList<Order> _orders =
        ...
        new Order { Id = 6, Status = "Gereed", Note = "Standaard order", Amount = 50, CreatedBy = "Marie-Louise", MadeBy = "Patrick" },
        new Order { Id = 7, Status = "In wachtrij", Note = "Wacht op materiaal", Amount = 30, CreatedBy = "Frank", MadeBy = "Pietje" },
        new Order { Id = 8, Status = "Geannuleerd", Note = "Order ingetrokken door klant", Amount = 15, CreatedBy = "Marie-Louise", MadeBy = "Thomas" },
        new Order { Id = 9, Status = "In productie", Note = "Extra kwaliteitscontrole vereist", Amount = 60, CreatedBy = "Frank", MadeBy = "Patrick" },
        new Order { Id = 10, Status = "Gereed", Note = "Spoedorder op tijd afgerond", Amount = 25, CreatedBy = "Marie-Louise", MadeBy = "Pietje" }
