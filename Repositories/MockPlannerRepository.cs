...
public class MockPlannerRepository : IPlannerRepository
{
    private static List<Planning> _plannings = new()
    {
        ...
        new Planning { ArticleNumber = 541, ArticleDescription = "9902400", Size = "Standaard", Color = "Chroom", TotalCurrentStockNL = 0, TotalCurrentStockPL = 8, Recommended7Days = 10, Recommended14Days = 16, Recommended30Days = 45, MaxPossibleProduction = 180, ReadyDate = DateTime.Today.AddDays(5) },
        new Planning { ArticleNumber = 14236, ArticleDescription = "Toiletpot", Size = "Normaal", Color = "Wit", TotalCurrentStockNL = 0, TotalCurrentStockPL = 4, Recommended7Days = 8, Recommended14Days = 14, Recommended30Days = 35, MaxPossibleProduction = 100, ReadyDate = DateTime.Today.AddDays(5) },
        new Planning { ArticleNumber = 14237, ArticleDescription = "Badkuip", Size = "160x70", Color = "Wit", TotalCurrentStockNL = 0, TotalCurrentStockPL = 1, Recommended7Days = 5, Recommended14Days = 8, Recommended30Days = 25, MaxPossibleProduction = 50, ReadyDate = DateTime.Today.AddDays(5) },
        ...
        new Planning { ArticleNumber = 14240, ArticleDescription = "Handdoekrek", Size = "50cm", Color = "Zwart", TotalCurrentStockNL = 0, TotalCurrentStockPL = 4, Recommended7Days = 9, Recommended14Days = 13, Recommended30Days = 30, MaxPossibleProduction = 100, ReadyDate = DateTime.Today.AddDays(5) },
        ...
        new Planning { ArticleNumber = 14243, ArticleDescription = "Douchestang", Size = "70cm", Color = "Zilver", TotalCurrentStockNL = 0, TotalCurrentStockPL = 3, Recommended7Days = 8, Recommended14Days = 14, Recommended30Days = 36, MaxPossibleProduction = 100, ReadyDate = DateTime.Today.AddDays(5) },
    };
