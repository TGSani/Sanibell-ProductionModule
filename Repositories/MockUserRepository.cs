...
public class MockUserRepository : IUsersRepository
{
    private static readonly IReadOnlyList<User> _users =
        ...
        new User { Id = 2, Name = "Pietje", Role = "ProductieMedewerker", QRcode = "222"},
        new User { Id = 3, Name = "Frank", Role = "Planner", QRcode = "333"},
        new User { Id = 4, Name = "Thomas", Role = "ProductieMedewerker", QRcode = "444"},
        new User { Id = 5, Name = "Sebastiaan", Role = "Planner", QRcode = "555"},
        new User { Id = 6, Name = "Gerrit", Role = "Administrator", QRcode = "666"},
        new User { Id = 7, Name = "Patrick", Role = "ProductieMedewerker", QRcode = "777"},
        new User { Id = 8, Name = "Koen", Role = "Planner", QRcode = "888"},
        new User { Id = 9, Name = "Tim", Role = "ProductieMedewerker", QRcode = "999"},
        new User { Id = 11, Name = "Hendrick-jan", Role = "ProductieMedewerker", QRcode = "112"},
